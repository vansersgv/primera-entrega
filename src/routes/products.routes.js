...
routerProd.put('/:pid', async (req, res) => {
    const isProductUpdated = await productManager.updateProduct(req.params.pid, req.body);
...
routerProd.delete('/:pid', async (req, res) => {
    const isProductDeleted = await productManager.deleteProduct(req.params.pid);
